function showToast(title, message, type = 'normal', duration = 3000) {
    ...
    // menghapus kelas sebelumnya -> memastikan notifikasi memiliki gaya yang benar
    ...
    // ini untuk animasi menghilang -> nanti toast bisa hilang setelah durasi yang ditentukan
    setTimeout(() => {
